...
//  clientScripts: [ 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js'  ],
...
var url = "http://car.ctrip.com/dayweb/city359?date=2017-11-29%2009:00&duration=1&refs=%7B%22cityId%22%3A359%2C%22items%22%3A%5B%7B%22cityIds%22%3A%5B%5D%2C%22day%22%3A1%2C%22desctription%22%3A%22%E6%9B%BC%E8%B0%B7%E5%B8%82%E5%86%85%E5%8C%85%E8%BD%A6%E6%9C%8D%E5%8A%A1%22%2C%22pathType%22%3A1%2C%22scope%22%3A%22%22%7D%5D%7D&iscross=false&isreturn=false&staydur=0"
...
//casper.echo(require('system').args[3])
//casper.echo("asdjfladsj")
// if (casper.page.injectJs("jquery.min.js")) {
//   capseper.echo("jladjsf")
// 
// }
casper.start(url).waitFor(function(){
  ...
  casper.page.injectJs("jquery-3.2.1.min.js");
  var result = this.evaluate(function(){
    ...
    $('div.cl_type').each(function() {
      ...
      $(this).next().find('.bb').each(function() {
        ...
        if (supply == "阿拉丁") {
          console.log(supply)
            $(this).parent().find('.bookingBtn').click();

          console.log( $('div.login_popup').attr("style"))
            if( $('div.login_popup').attr("style") == "display:none"){
              console.log( $(this).parent().find('.bookingBtn').text())
                $('#sso_btnDirectBook').click();
            }
          console.log( $('div.login_popup').attr("style"))
            var infos = $(this).parent().find('#booking-rules-box').text();
          console.log(infos);
  ...
  //      }
        ...
        //  }
        //  console.log( $('div.login_popup').attr("style"))
        //  var infos = $(this).find('#booking-rules-box').text();
        //  console.log(infos);
        //  console.log("in follow");
        //} 
       // var service = [];
